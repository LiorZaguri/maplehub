          ...
          <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-muted-foreground/20 scrollbar-track-transparent">
            {selectedCharacters.map((character) => {
              ...
              return (
                <div 
                  key={character.id} 
                  className={`flex-shrink-0 w-80 p-4 rounded-lg border relative cursor-pointer transition-all hover:shadow-md ${
                    isActive 
            ...
            <Sheet open={isCharacterSheetOpen} onOpenChange={setIsCharacterSheetOpen}>
              <SheetTrigger asChild>
                <div className="flex-shrink-0 w-80 p-4 rounded-lg border border-dashed border-muted-foreground/30 cursor-pointer hover:bg-muted/50 transition-colors">
